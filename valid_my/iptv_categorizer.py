...
region_map = {
    ...
    '凤凰': '香港', 'TVB': '香港',
    '中天': '台湾', '东森': '台湾',
    'Astro': '马来西亚', '新传媒': '新加坡', 'Channel 8': '新加坡',
    'BBC': '英国', 'CNN': '美国', 'HBO': '美国', 'ESPN': '美国',
    'ABC': '澳大利亚',
    'Zee': '印度', 'Star': '印度',
    'Trans': '印尼', 'RCTI': '印尼', 'TVRI': '印尼', 'Metro': '印尼'
}

type_map = {
    '新闻': '新闻', 'News': '新闻', 'CCTV-13': '新闻', 'BBC': '新闻', 'CNN': '新闻',
    '娱乐': '娱乐', '综艺': '娱乐', 'Star': '娱乐', 'TVB': '娱乐', 'Astro': '娱乐', 'Trans': '娱乐',
    '电影': '电影', 'Cinema': '电影', 'HBO': '电影',
    '体育': '体育', 'Sports': '体育', 'ESPN': '体育',
